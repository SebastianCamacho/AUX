...
namespace DAL.InternalMigratons
{
    ...
    [Migration("20250402043559_Agregacion_Propietarios_Contratantes")]
    partial class Agregacion_Propietarios_Contratantes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ENTITY.Contracting_Party", b =>
                {
                    ...
                    b.Property<string>("third_Partyid_Third")
                        .HasColumnType("VARCHAR(20)");

                    b.HasKey("id_");

                    b.HasIndex("third_Partyid_Third");
            ...
            modelBuilder.Entity("ENTITY.Contracting_Party", b =>
                {
                    b.HasOne("ENTITY.Third_Party", "third_Party")
                        .WithMany()
                        .HasForeignKey("third_Partyid_Third");
